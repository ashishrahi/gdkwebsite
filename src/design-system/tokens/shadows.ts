export const shadowTokens = {
  ...
  cardSubtle: "0 3px 12px color-mix(in srgb, var(--brand-green-950) 3.5%, transparent)",
  cardMedium: "0 8px 22px color-mix(in srgb, var(--brand-green-950) 5.5%, transparent)",
  cardElevated: "0 10px 28px color-mix(in srgb, var(--brand-green-950) 5.5%, transparent)",
  cardHoverElevation: "0 14px 32px color-mix(in srgb, var(--brand-green-950) 8.5%, transparent)",
  card: "0 8px 22px color-mix(in srgb, var(--brand-green-950) 5.5%, transparent)",
  cardSoft: "0 10px 28px color-mix(in srgb, var(--brand-green-950) 5.5%, transparent)",
  cardHover: "0 14px 32px color-mix(in srgb, var(--brand-green-950) 8.5%, transparent)",
  nav: "0 8px 24px color-mix(in srgb, var(--brand-green-950) 8%, transparent)",
  megaMenu: "0 22px 52px color-mix(in srgb, var(--brand-green-950) 16%, transparent)",
  heroPanel: "0 16px 42px color-mix(in srgb, var(--brand-green-950) 16%, transparent)",
